...
class _ESMFRegridder:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Either Constants.Method.BILINEAR or Constants.Method.NEAREST.
        ...
        """
        if method not in [Constants.Method.CONSERVATIVE, Constants.Method.BILINEAR, Constants.Method.NEAREST]:
            raise NotImplementedError(
                f"method must be either 'bilinear', 'conservative' or 'nearest', got '{method}'."
            )
        if mdtol is None:
